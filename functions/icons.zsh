...
function p9k::register_segment() {
  ...
  __p9k_find_first_defined "P9K_${STATEFUL_NAME}_LEFT_WHITESPACE" \
    "P9K_LEFT_WHITESPACE_OF_LEFT_SEGMENTS" "P9K_WHITESPACE_BETWEEN_LEFT_SEGMENTS"
  __P9K_DATA[${STATEFUL_NAME}_LEFT_LEFT_WHITESPACE]="${__P9K_RETVAL}"
  # Middle whitespace of left segments
  __p9k_find_first_defined "P9K_${STATEFUL_NAME}_MIDDLE_WHITESPACE" \
    "P9K_MIDDLE_WHITESPACE_OF_LEFT_SEGMENTS"
  __P9K_DATA[${STATEFUL_NAME}_LEFT_MIDDLE_WHITESPACE]="${__P9K_RETVAL}"
  # Right whitespace of left segments
  __p9k_find_first_defined "P9K_${STATEFUL_NAME}_RIGHT_WHITESPACE" \
    "P9K_RIGHT_WHITESPACE_OF_LEFT_SEGMENTS" "P9K_WHITESPACE_BETWEEN_LEFT_SEGMENTS"
  __P9K_DATA[${STATEFUL_NAME}_LEFT_RIGHT_WHITESPACE]="${__P9K_RETVAL}"

  # Left whitespace of right segments
  __p9k_find_first_defined "P9K_${STATEFUL_NAME}_LEFT_WHITESPACE" \
    "P9K_LEFT_WHITESPACE_OF_RIGHT_SEGMENTS" "P9K_WHITESPACE_BETWEEN_RIGHT_SEGMENTS"
  __P9K_DATA[${STATEFUL_NAME}_RIGHT_LEFT_WHITESPACE]="${__P9K_RETVAL}"
  # Middle whitespace of right segments
  __p9k_find_first_defined "P9K_${STATEFUL_NAME}_MIDDLE_WHITESPACE" \
    "P9K_MIDDLE_WHITESPACE_OF_RIGHT_SEGMENTS"
  __P9K_DATA[${STATEFUL_NAME}_RIGHT_MIDDLE_WHITESPACE]="${__P9K_RETVAL}"
  # Right whitespace of right segments
  __p9k_find_first_defined "P9K_${STATEFUL_NAME}_RIGHT_WHITESPACE" \
    "P9K_RIGHT_WHITESPACE_OF_RIGHT_SEGMENTS" "P9K_WHITESPACE_BETWEEN_RIGHT_SEGMENTS"
  __P9K_DATA[${STATEFUL_NAME}_RIGHT_RIGHT_WHITESPACE]="${__P9K_RETVAL}"
  ...
  __p9k_find_first_defined "P9K_LEFT_PROMPT_FIRST_SEGMENT_START_WHITESPACE" "first_ws"
  __P9K_DATA[FIRST_WHITESPACE]="${__P9K_RETVAL}"
  local last_ws="${__P9K_DATA[${STATEFUL_NAME}_RIGHT_RIGHT_WHITESPACE]}"
  __p9k_find_first_defined "P9K_RIGHT_PROMPT_LAST_SEGMENT_END_WHITESPACE" "last_ws"
  __P9K_DATA[LAST_WHITESPACE]="${__P9K_RETVAL}"
